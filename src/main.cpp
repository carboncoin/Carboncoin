...
uint256 hashGenesisBlock("0xa94f1aae8c409a0bd1e53cbca92d7e506b61c51d955cf56f76da501718d48d6c");
...
static const int64 nTargetTimespan = 12 * 100; // CarbonCoin: every 4 hours
static const int64 nTargetSpacing = 100; // CarbonCoin: 100 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal CarbonCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CarbonCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1389199888;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 605268;

        if (fTestNet)
        {
            block.nTime    = 1389199887;
            block.nNonce   = 5987453;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x074bbb9d355731bfa8f67130e2179db7518d1387ad52e55309d4debe7d4e6383"));
...
unsigned char pchMessageStart[4] = { 0xab, 0xcc, 0xbb, 0xdf }; // CarbonCoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // CarbonCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
